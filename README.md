...
```
docs: add live demo link and README badge (https://hackerscheatsheet.onrender.com)
```
...
git commit -m "docs: add live demo link and README badge (https://hackerscheatsheet.onrender.com)"
